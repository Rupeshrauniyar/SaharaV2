    ...
    try {
        ...
        const hospital = await HospitalModel.create({
            ...
            beds: {
                ...
                available:
                    Number(beds?.available) || 0,

                icu:
                    Number(beds?.icu) || 0,

                emergency:
                    Number(beds?.emergency) || 0,
            },
...
const updateBloodInventory = async (req, res) => {
    try {
        ...
        for (const bloodGroup of validBloodGroups) {
            ...
            if (
                inventory[bloodGroup] !== undefined
            ) {

                const amount =
                    Number(inventory[bloodGroup]);
                ...
                if (
                    ...
                    return res.status(400).json({
                        ...
                        message:
                            `Invalid inventory value for ${bloodGroup}.`
                    });
                }


                hospital.bloodInventory[bloodGroup] =
                    amount;
            }
        }
